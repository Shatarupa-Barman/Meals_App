...
// it shows all meal cards in main according to search input value
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12 text-center">
                            <span class="display-1 d-block">
                             ...
                             <div class="emoji">😞</div>
                            <div class="mb-4 lead">
                                No meal is added in your favourites list.
                            </div>
                        </div>
                    </div>
                </div>
...
function addRemoveToFavList(id) {
  ...
  if (contain) {
    ...
    arr.push(id);
    alert("your meal will be added to your favourites list");
  }
